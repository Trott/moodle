...
$string['datasetsizelimited'] = 'Only part of the dataset has been evaluated due to its size. Set $CFG->mlbackend_php_no_evaluation_limits if you are confident that your system can cope with a {$a} dataset.';
